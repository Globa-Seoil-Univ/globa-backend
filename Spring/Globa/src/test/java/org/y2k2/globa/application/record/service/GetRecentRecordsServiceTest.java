...
public class GetRecentRecordsServiceTest {
    @InjectMocks
    ...
    void getRecentRecords() {
        ...
        Mockito.when(recordRepository.getAccessibleRecord(userId, pageable))
        ...
        ResponseRecordsDto response = getRecentRecordsService.get(page, count, userId);

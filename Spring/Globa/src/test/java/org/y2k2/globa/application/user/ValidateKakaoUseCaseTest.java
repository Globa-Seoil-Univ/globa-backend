...
public class ValidateKakaoUseCaseTest {
    ...
    private ValidateKakaoUseCase validateKakaoSnsUseCase;
    ...
    @BeforeEach
    void setUp() {
        validateKakaoSnsUseCase = new ValidateKakaoUseCase(restTemplate);
        command = new ValidateSnsCommand("12345", "valid_token");
    }

...
public class CreateReplyServiceTest {
    @InjectMocks
    ...
    void createReply_Success() {
        ...
        CommentEntity parent = FixtureMonkey.builder()
                .objectIntrospector(BeanArbitraryIntrospector.INSTANCE)
                .defaultNotNull(true)
                .build()
        ...
        Mockito
                .when(commentRepository.getParentComment(idsDto.highlightId(), idsDto.parentId()))
        ...
        createReplyService.create(idsDto, request);
        ...
        Mockito.verify(commentRepository, Mockito.times(1))
                .getParentComment(idsDto.highlightId(), idsDto.parentId());

...
public class DictionaryController {
    private final GetDictionaryService getDictionaryService;
    private final CreateDictionaryService createDictionaryService;
    ...
    @GetMapping
    public ResponseEntity<ResponseDictionaryDto> getDictionary(
            @RequestParam(value = "keyword") String keyword
    ) {
        return ResponseEntity.ok().body(getDictionaryService.get(keyword));
    }
    ...
    public ResponseEntity<?> addDictionary(
        ...
        createDictionaryService.create(details.getUserId());

...
public interface RecordMapper {
    ...
    IntroRecordDto toIntroRecordDto(RecordEntity record);
    ...
    ResponseRecordDto toResponseRecordDto(RecordEntity record, Long folderId, List<ResponseKeywordDto> keywords);

...
public class GetFolderSharesService {
    ...
    public ResponseFolderShareUserDto get(Long folderId, int page, int count, Long userId) {
        findFolderAndThrowUseCase.execute(FindFolderCommand.of(folderId, userId));

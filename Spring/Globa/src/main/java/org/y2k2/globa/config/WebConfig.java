...
public class WebConfig implements WebMvcConfigurer {
    ...
    private HandlerInterceptor authenticationInterceptor() {
        ...
        return interceptor
                ...
                .includePathPattern("/notification/unread/check",PathMethod.GET)
                .includePathPattern("/notification/unread",PathMethod.GET)
                .includePathPattern("/notification/unread/count",PathMethod.GET)
                .includePathPattern("/notification/{_:[0-9]}",PathMethod.POST)
                .includePathPattern("/notification/{_:[0-9]}",PathMethod.DELETE)

...
public interface InquiryRepository {
    ...
    Page<InquiryEntity> getInquiries(UserEntity user, Pageable pageable);
    Page<InquiryEntity> getSolvedInquiries(UserEntity user, Pageable pageable);
    Page<InquiryEntity> getUnsolvedInquiries(UserEntity user, Pageable pageable);

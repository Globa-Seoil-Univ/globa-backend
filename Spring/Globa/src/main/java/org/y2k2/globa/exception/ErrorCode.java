...
public enum ErrorCode {
    ...
    MISMATCH_ANALYSIS_OWNER(HttpStatus.FORBIDDEN, "해당 분석에 대한 소유권자가 아닙니다.", 40344),
    MISMATCH_QUIZ_RECORD_ID(HttpStatus.FORBIDDEN, "해당 문서의 퀴즈가 아닙니다.", 40346),
    MISMATCH_RECORD_OWNER(HttpStatus.FORBIDDEN, "해당 문서에 대한 소유권자가 아닙니다.", 40347),
    MISMATCH_RECORD_FOLDER(HttpStatus.FORBIDDEN, "해당 폴더의 문서가 아닙니다. ", 40348),
    DELETED_USER(HttpStatus.FORBIDDEN, "탈퇴된 유저입니다. ", 40350),
    NOT_ALLOW_NOTIFICATION_SETTING(HttpStatus.FORBIDDEN, "알림 설정이 허용되지 않았습니다.", 40360),
    ...
    NOT_FOUND_ROLE(HttpStatus.NOT_FOUND, "권한을 찾을 수 없습니다. ", 40413),

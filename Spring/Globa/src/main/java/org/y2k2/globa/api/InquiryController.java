...
public class InquiryController {
    ...
    @GetMapping
    public ResponseEntity<ResponseInquiryDto> getInquires(
        ...
        return ResponseEntity.ok().body(getInquiresService.get(paginationDto, details.getUserId()));
    }
    ...
    public ResponseEntity<ResponseInquiryDetailDto> getInquiry(
            @PathVariable(name = "inquiryId") long inquiryId,
            @AuthenticationPrincipal CustomUserDetails details
    ) { return ResponseEntity.ok().body(getInquiryService.get(inquiryId, details.getUserId())); }
    ...
    public ResponseEntity<Void> addInquiry(
        ...
        Long inquiryId = createInquiryService.create(dto, details.getUserId());
